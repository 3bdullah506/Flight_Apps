...
class PdfService {
  ...
  static Future<void> generateTicket({
    ...
    final String bookingId   = order['bookingId']?.toString()  ?? 'BK-${order['id']}';
    ...
    try { flightDateStr = DateFormat('dd/MM/yyyy').format(order['flightDate'].toDate()); } catch (_) {}
              ...
              pw.Container(
                ...
                child: pw.Row(
                  ...
                  children: [
                      ...
                      children: [
                        pw.Text(origin,
                            style: pw.TextStyle(
                                ...
                                color: PdfColors.indigo900)),
                        pw.Text(depTime,
                            style: const pw.TextStyle(fontSize: 16, color: PdfColors.indigo700)),
                    ...
                    pw.Column(
                      children: [
                        pw.Text('✈', style: const pw.TextStyle(fontSize: 24, color: PdfColors.indigo400)),
                        pw.SizedBox(height: 4),
                    ...
                    pw.Expanded(
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          _infoRow('رقم الهوية / الجواز', passport.isEmpty ? '-' : passport),
                        ],
                      ),
                    ),
                    ...
                    pw.Expanded(
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          _infoRow('سعر التذكرة', '\$${price.toStringAsFixed(2)}'),
  ...
  static Future<void> generateInvoice({
    ...
    double total = orders.fold(0.0, (sum, o) => sum + (o['price'] as num).toDouble());
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('التاريخ: ${DateFormat('dd/MM/yyyy').format(DateTime.now())}',
                        style: const pw.TextStyle(color: PdfColors.white)),
                  ],
                ),
              ),
              pw.SizedBox(height: 20),
              pw.Text('بيانات العميل', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold)),
              pw.Divider(),
              pw.Text('الاسم: $customerName'),
              pw.Text('البريد الإلكتروني: $customerEmail'),
              pw.SizedBox(height: 20),
              pw.Text('تفاصيل الحجوزات', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold)),
              ...
              pw.Table(
                ...
                children: [
                  pw.TableRow(
                    ...
                    children: [_cell('المسار', isHeader: true), _cell('التاريخ', isHeader: true),
                      _cell('السعر', isHeader: true), _cell('الحالة', isHeader: true)],
                  ),
                  ...orders.map((order) {
                    String dateStr = '';
                    try { dateStr = DateFormat('dd/MM/yyyy').format(order['flightDate'].toDate()); } catch (_) {}
                    String st = order['status'] == 'approved' ? 'مقبول' : order['status'] == 'rejected' ? 'مرفوض' : 'قيد المراجعة';
              ...
              pw.Spacer(),
              pw.Divider(),
              pw.Center(child: pw.Text('شكراً لاستخدامكم خدمة حجز تذاكر الطيران',
